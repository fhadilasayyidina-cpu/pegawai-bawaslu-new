...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'app_custom.name' => 'string',
            'app_custom.logo' => 'string',
            'app_custom.organization.short_name' => 'string',
            'app_custom.organization.full_name' => 'string',
            ...
            'filesystems.links./home/fadil/Project/pegawai-bawaslu-new/public/storage' => 'string',
...
'app.aliases.View','app.aliases.Vite','app_custom.name','app_custom.logo','app_custom.organization.short_name',
'app_custom.organization.full_name','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver','auth.guards.web.provider',
...
'filesystems.links./home/fadil/Project/pegawai-bawaslu-new/public/storage','fortify.guard','fortify.middleware','fortify.auth_middleware','fortify.passwords',
...
'mail.from.name','mail.markdown.theme','mail.markdown.paths','mary.prefix','mary.route_prefix',
'mary.components.spotlight.class','pulse.domain','pulse.path','pulse.enabled','pulse.storage.driver',
...
'debugbar.collectors.pennant','debugbar.collectors.ai','debugbar.collectors.http_client','debugbar.options.time.memory_usage','debugbar.options.messages.trace',
...
'debugbar.options.cache.values','debugbar.options.cache.timeline','debugbar.options.http_client.masked','debugbar.options.http_client.timeline','debugbar.options.ai.values',
...
'signed','throttle','verified','check.role','auto.login.test',);
...
'livewire.preview-file','mary.toogle-sidebar','mary.spotlight','mary.upload','laravel-folio','home','dashboard','cuti.pdf','admin.dashboard',
'admin.absensis.index','admin.absensis.create','admin.absensis.import','admin.absensis.details','admin.absensis.edit',
'admin.cutis.index','admin.cutis.create','admin.cutis.details','admin.cutis.edit','admin.hari-liburs.index',
'admin.kgbs.index','admin.kgbs.import','admin.kgbs.create-pns','admin.kgbs.create-pppk','admin.kgbs.pns-pdf',
'admin.kgbs.pppk-pdf','admin.pegawais.index','admin.pegawais.import','admin.pegawais.import-id-absensi','admin.pegawais.details',
'admin.pegawais.absensis','admin.pimpinans.index','admin.pimpinans.create','admin.pimpinans.details','admin.pimpinans.edit',
'admin.users.index','admin.users.create','admin.users.edit','operator.dashboard','operator.pegawais.index',
'operator.pegawais.details','operator.pimpinans.index','operator.pimpinans.details','operator.pimpinans.edit','pegawai.dashboard','profile.edit','user-password.edit','appearance.edit','two-factor.show','storage.local',);
...
'components.desktop-user-menu','components.header-page','components.layouts.app','components.layouts.app.header','components.layouts.app.sidebar',
...
'components.settings.layout','components.statistic-card','dashboard','e60dd9d2c3a62d619c9acb38f20d5aa5::icon.book-open-text','e60dd9d2c3a62d619c9acb38f20d5aa5::icon.chevrons-up-down',
...
'flux.icon.folder-git-2','flux.icon.layout-grid','flux.navlist.group','livewire.admin.absensis.create','livewire.admin.absensis.details',
'livewire.admin.absensis.edit','livewire.admin.absensis.import','livewire.admin.absensis.index','livewire.admin.cuti.create','livewire.admin.cuti.details',
'livewire.admin.cuti.edit','livewire.admin.cuti.index','livewire.admin.dashboard','livewire.admin.edit-user','livewire.admin.hari-libur.index',
'livewire.admin.kgbs.create-pns','livewire.admin.kgbs.create-pppk','livewire.admin.kgbs.import','livewire.admin.kgbs.index','livewire.admin.pegawai.absensis',
'livewire.admin.pegawai.details','livewire.admin.pegawai.index','livewire.admin.pegawais.import-id-absensi','livewire.admin.pimpinan.details','livewire.admin.pimpinan.index',
'livewire.admin.users.create','livewire.admin.users.index','livewire.auth.confirm-password','livewire.auth.forgot-password','livewire.auth.login',
'livewire.auth.register','livewire.auth.reset-password','livewire.auth.two-factor-challenge','livewire.auth.verify-email','livewire.operator.dashboard',
'livewire.operator.pegawai.details','livewire.operator.pegawai.index','livewire.operator.pimpinan.details','livewire.operator.pimpinan.index','livewire.settings.appearance',
'livewire.settings.delete-user-form','livewire.settings.password','livewire.settings.profile','livewire.settings.two-factor','livewire.settings.two-factor.recovery-codes',
'livewire.test','pages.admin.absensis.[id].details','pages.admin.absensis.[id].edit','pages.admin.absensis.create','pages.admin.absensis.details',
'pages.admin.absensis.edit','pages.admin.absensis.import','pages.admin.absensis.index','pages.admin.cutis.[id].details','pages.admin.cutis.[id].edit',
'pages.admin.cutis.create','pages.admin.cutis.details','pages.admin.cutis.edit','pages.admin.cutis.index','pages.admin.dashboard',
'pages.admin.hari-liburs.index','pages.admin.kgbs.create-pns','pages.admin.kgbs.create-pppk','pages.admin.kgbs.import','pages.admin.kgbs.index',
'pages.admin.pegawais.[id].absensis','pages.admin.pegawais.[id].details','pages.admin.pegawais.absensis','pages.admin.pegawais.details','pages.admin.pegawais.import',
'pages.admin.pegawais.import-id-absensi','pages.admin.pegawais.index','pages.admin.pimpinans.[id].details','pages.admin.pimpinans.[id].edit','pages.admin.pimpinans.create',
'pages.admin.pimpinans.details','pages.admin.pimpinans.edit','pages.admin.pimpinans.index','pages.admin.users.[User].edit','pages.admin.users.create',
'pages.admin.users.edit','pages.admin.users.index','pages.operator.dashboard','pages.operator.pegawais.[id].details','pages.operator.pegawais.details',
'pages.operator.pegawais.index','pages.operator.pimpinans.[id].details','pages.operator.pimpinans.[id].edit','pages.operator.pimpinans.details','pages.operator.pimpinans.edit',
'pages.operator.pimpinans.index','pages.pegawai.dashboard','pages.test','partials.head','partials.settings-heading',
'pdf.surat-cuti','volt-livewire::admin.absensis.[id].details','volt-livewire::admin.absensis.[id].edit','volt-livewire::admin.absensis.create','volt-livewire::admin.absensis.create',
'volt-livewire::admin.absensis.details','volt-livewire::admin.absensis.details','volt-livewire::admin.absensis.edit','volt-livewire::admin.absensis.edit','volt-livewire::admin.absensis.import',
'volt-livewire::admin.absensis.import','volt-livewire::admin.absensis.index','volt-livewire::admin.absensis.index','volt-livewire::admin.cuti.create','volt-livewire::admin.cuti.details',
'volt-livewire::admin.cuti.edit','volt-livewire::admin.cuti.index','volt-livewire::admin.cutis.[id].details','volt-livewire::admin.cutis.[id].edit','volt-livewire::admin.cutis.create',
'volt-livewire::admin.cutis.details','volt-livewire::admin.cutis.edit','volt-livewire::admin.cutis.index','volt-livewire::admin.dashboard','volt-livewire::admin.dashboard',
'volt-livewire::admin.edit-user','volt-livewire::admin.hari-libur.index','volt-livewire::admin.hari-liburs.index','volt-livewire::admin.kgbs.create-pns','volt-livewire::admin.kgbs.create-pns',
'volt-livewire::admin.kgbs.create-pppk','volt-livewire::admin.kgbs.create-pppk','volt-livewire::admin.kgbs.import','volt-livewire::admin.kgbs.import','volt-livewire::admin.kgbs.index',
'volt-livewire::admin.kgbs.index','volt-livewire::admin.pegawai.absensis','volt-livewire::admin.pegawai.details','volt-livewire::admin.pegawai.index','volt-livewire::admin.pegawais.[id].absensis',
'volt-livewire::admin.pegawais.[id].details','volt-livewire::admin.pegawais.absensis','volt-livewire::admin.pegawais.details','volt-livewire::admin.pegawais.import','volt-livewire::admin.pegawais.import-id-absensi',
'volt-livewire::admin.pegawais.import-id-absensi','volt-livewire::admin.pegawais.index','volt-livewire::admin.pimpinan.details','volt-livewire::admin.pimpinan.index','volt-livewire::admin.pimpinans.[id].details',
'volt-livewire::admin.pimpinans.[id].edit','volt-livewire::admin.pimpinans.create','volt-livewire::admin.pimpinans.details','volt-livewire::admin.pimpinans.edit','volt-livewire::admin.pimpinans.index',
'volt-livewire::admin.users.[User].edit','volt-livewire::admin.users.create','volt-livewire::admin.users.create','volt-livewire::admin.users.edit','volt-livewire::admin.users.index',
'volt-livewire::admin.users.index','volt-livewire::auth.confirm-password','volt-livewire::auth.forgot-password','volt-livewire::auth.login','volt-livewire::auth.register',
'volt-livewire::auth.reset-password','volt-livewire::auth.two-factor-challenge','volt-livewire::auth.verify-email','volt-livewire::operator.dashboard','volt-livewire::operator.dashboard',
'volt-livewire::operator.pegawai.details','volt-livewire::operator.pegawai.index','volt-livewire::operator.pegawais.[id].details','volt-livewire::operator.pegawais.details','volt-livewire::operator.pegawais.index',
'volt-livewire::operator.pimpinan.details','volt-livewire::operator.pimpinan.index','volt-livewire::operator.pimpinans.[id].details','volt-livewire::operator.pimpinans.[id].edit','volt-livewire::operator.pimpinans.details',
'volt-livewire::operator.pimpinans.edit','volt-livewire::operator.pimpinans.index','volt-livewire::pegawai.dashboard','volt-livewire::settings.appearance','volt-livewire::settings.delete-user-form',
'volt-livewire::settings.password','volt-livewire::settings.profile','volt-livewire::settings.two-factor','volt-livewire::settings.two-factor.recovery-codes','volt-livewire::test',
'volt-livewire::test','welcome','7224ff0b1fa42156c352216deff15b56::card','7224ff0b1fa42156c352216deff15b56::card-header','7224ff0b1fa42156c352216deff15b56::http-method-badge',
...
'7224ff0b1fa42156c352216deff15b56::thead','7224ff0b1fa42156c352216deff15b56::theme-switcher','7224ff0b1fa42156c352216deff15b56::user-card','e60dd9d2c3a62d619c9acb38f20d5aa5::accent','e60dd9d2c3a62d619c9acb38f20d5aa5::aside',
