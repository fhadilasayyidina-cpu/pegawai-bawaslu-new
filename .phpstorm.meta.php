...
'boost.browser_logs_watcher','mcp.redirect_domains','livewire.class_namespace','livewire.view_path','livewire.layout',
...
'livewire.pagination_theme','livewire.release_token','mary.prefix','mary.route_prefix','mary.components.spotlight.class',
...
'components.action-message','components.admin.sidebar-item-list','components.app-logo','components.app-logo-icon','components.auth-header',
'components.auth-session-status','components.desktop-user-menu','components.layouts.app','components.layouts.app.header','components.layouts.app.sidebar',
...
'livewire.test','pages.admin.dashboard','pages.admin.manajemen-user','pages.test','partials.head',
'partials.settings-heading','volt-livewire::admin.dashboard','volt-livewire::admin.manajemen-user','volt-livewire::auth.confirm-password','volt-livewire::auth.forgot-password',
...
'volt-livewire::settings.appearance','volt-livewire::settings.delete-user-form','volt-livewire::settings.password','volt-livewire::settings.profile','volt-livewire::settings.two-factor',
'volt-livewire::settings.two-factor.recovery-codes','volt-livewire::test','volt-livewire::test','welcome','e60dd9d2c3a62d619c9acb38f20d5aa5::accent',
